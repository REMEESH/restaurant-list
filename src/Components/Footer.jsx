...
function Footer() {
    return (
        <div style={{ width: '100%', height: '350px', }}  className='d-flex flex-column justify-content-center align-items-center'>
            <div className="footer-div d-flex justify-content-evenly flex-wrap w-100">
                <div className="website" style={{ width: '400px' }}>
                    <h4 className='text-white'><i class="fa-solid fa-utensils fa-beat"></i>Resturent</h4>
